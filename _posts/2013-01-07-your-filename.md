...
Облака это хорошо. Звучит наивно? Вполне. Давайте представим ситуацию, когда вам необходимо арендовать виртуальный сервер для реального проекта. Одним из самых доверенных провайдеров выделенных серверов является [Linode](http://www.linode.com/). Давайте сравним стоимость, сервис и производительность!
...
### PACI REST API и интеграция сервиса
